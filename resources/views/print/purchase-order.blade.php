...
<head>
    ...
    <style>
        ...
        * {
        ...
        .items-table td:nth-child(3) {
            width: 45%;  /* ProductName - column หลัก */
            max-width: 45%;
            /* การจัดการการขึ้นบรรทัดใหม่ */
        ...
        <div class="po-info-section">
            <div class="po-info-grid">
                <div class="po-info-box-L">
                    <div class="info-row">
                        <span class="info-value" style="margin-left: 20px;"><strong>{{ $po->header->SupNo }} : {{ $po->header->SupName }}</strong></span>
                    </div>
                    <div class="info-row">
                    ...
                    <span class="info-value" style="margin-left: 20px;">
                        @if(empty(trim($po->header->ContractSup)))
                            ผู้ติดต่อ:
                        @else
                            {{ $po->header->ContractSup }}
                        @endif
                    </span>
                    <div class="info-row">
